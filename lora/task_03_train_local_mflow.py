...
def train():
    ...
    with mlflow.start_run() as run:
        ...
        # 전역 config 상수를 한눈에 볼 수 있도록 딕셔너리로 묶어 등록
        all_configs = {
        ...
        # Save Adapter (config.py의 ARTIFACT_DIR 활용)
        adapter_save_dir = f"{config.ARTIFACT_DIR}/lora_output"
